...
int main(){  
    ...
    if(decision == 1){
        if(surprise != 1)
            cout << "Asian food.. nice choice! Now how expensive of a meal do you want? Enter the corresponding number:";
        ...
        if(surprise !=1)
            cout << "Good pick, you have fine tastebuds! Now how expensive of a meal do you want? Enter the corresponding number:";
        cout << "1- I need something on the cheaper side, I'm a college student! 2- I can spend a moderate amount. 3- I feel like spoiling myself!" <<endl;
        cin >> money;
        cout<< endl << "Your options are: " << endl;
        ...
        if(surprise !=1)
            cout << "Italian food, simple but tasty! Now how expensive of a meal do you want? Enter the corresponding number:";
        cout << "1- I need something on the cheaper side, I'm a college student! 2- I can spend a moderate amount. 3- I feel like spoiling myself!" <<endl;
        cin >> money;
        cout<< endl << "Your options are: " << endl;
        ...
        if(surprise !=1)
            cout << "Keeping it basic, I like that! Now how expensive of a meal do you want?\nEnter the corresponding number:";
        cout << "1- I need something on the cheaper side, I'm a college student! 2- I can spend a moderate amount. 3- I feel like spoiling myself!" <<endl;
        cin >> money;
        cout<< endl << "Your options are: " << endl;
        GR.search(money);
        ...
        if(surprise !=1)
            cout << "Not the healthiest, but defintely superior!\nNow how expensive of a meal do you want? Enter the corresponding number:" << endl;
        cout << "1- I need something on the cheaper side, I'm a college student! 2- I can spend a moderate amount. 3- I feel like spoiling myself!" <<endl;
        cin >> money;
        cout<< endl << "Your options are: " << endl;
        FF.search(money);
